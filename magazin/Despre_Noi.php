...
<body> 
    ...
    <div class="img">
    <img src="copil citind.jpg" alt="about us photo" title="Libraria PRINTRE CARTI" width="800"/>
    </div>

    <div class='h1'>
    <h1> Din pasiune pentru carti </h1>
    </div>
    <br>   

    <div class="h2">
    <h2> si din respect pentru dumneavoastra.</h2>
    </div>
